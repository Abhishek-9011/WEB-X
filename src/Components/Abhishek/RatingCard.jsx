...
function RatingCard({ imageSrc, location, reviews, street, openingTime }) {
  ...
  return (
    <div className="bg-[#1c1b20] p-4 rounded-xl text-white shadow-lg">
      {/* Image */}
      ...
      <div className="flex items-center">
        <div className="flex -space-x-2">
          <img src="/profile1.png" alt="User 1" className="w-8 h-8 rounded-full border-2 border-[#1d1b21]" />
          <img src="/profile2.png" alt="User 2" className="w-8 h-8 rounded-full border-2 border-[#1d1b21]" />
          <img src="/profile3.png" alt="User 3" className="w-8 h-8 rounded-full border-2 border-[#1d1b21]" />
        </div>
